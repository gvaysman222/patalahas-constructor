      ...
      if (state.step === 4) {
        ...
        if (textInput) {
          ...
          textInput.oninput = (e) => {
            ...
            const limitedValue = enforceTextInputLineLimits(rawValue, template, printSize);
            state.textValue = limitedValue;
            if (e.target.value !== limitedValue) {
              const cursorPos = Math.min(e.target.selectionStart, limitedValue.length);
