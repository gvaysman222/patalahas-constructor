...
// ===== constructor-checkout-mvp-tilda-js-1.html =====
    ...
    const KONVA_TEMPLATE_CONFIGS = {
      ...
      'polaroid-photo': {
        ...
        photoPosition: 'center',
        photoDefaults: { exportX: 456, exportY: 583, scale: 0.8 },
        frameDefaults: { exportX: 456, exportY: 483, scale: 0.8 },
        printSizeOverrides: {
          l: { photoExportX: 436, photoExportY: 583, photoScale: 0.822, frameExportX: 436, frameExportY: 483, frameScale: 0.822 },
        },
    ...
    function buildKonvaSceneParams() {
      ...
      return {
        ...
        frameSrc: selectedTemplate?.kind === 'polaroid-photo' ? normalizeExportImageUrl(POLAROID_FRAME_IMAGE_URL) : null,
