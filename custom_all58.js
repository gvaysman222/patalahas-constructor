...
function renderLeftSummary() {
    ...
    function getDesignLayerRenderState() {
      ...
      const uploadsHtml = activeUpload
        ? `<img class="crop-image" src="${activeUpload.url}" alt="preview" style="filter:${filter}; transform-origin:50% 50%; transform:translate(${state.cropPosition.x}%, ${state.cropPosition.y}%) scale(${state.cropZoom});">`
