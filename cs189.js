          ...
          <div class="step-1-meta-row">
            <div class="step-1-size-block">
              <div class="field-title">
                ${sizeChartImages[state.product] ? `<span class="size-chart-hint" tabindex="0" aria-label="Размерная сетка"><span class="size-chart-hint-icon">?</span><span class="size-chart-hint-tip"><img src="${sizeChartImages[state.product]}" alt="Размерная сетка" loading="lazy"></span></span>` : ''}
                <span>Размер</span>
              </div>
