...
(function initConstructorCheckoutTemplateConfig(global) {
  ...
  global.CONSTRUCTOR_CHECKOUT_TEMPLATE_CONFIG = {
    ...
    customTemplates: [
      { id: 'custom-1', name: 'Индивидуальный дизайн 1', note: 'Разработка дизайнером', price: 1900, previewImage: 'https://www.dropbox.com/scl/fo/32sdavmje7anx9fg8h13a/ADGeI8JB8vH2CU-zKFP2-9w/001.png?rlkey=hko8iad8atbm6bukwynhqlvps&st=fhiycxfb&raw=1' },
      { id: 'custom-2', name: 'Индивидуальный дизайн 2', note: 'Разработка дизайнером', price: 2400, previewImage: 'https://www.dropbox.com/scl/fo/32sdavmje7anx9fg8h13a/APT4Bvd9uJzDm2uWBDiqHmk/002.png?rlkey=hko8iad8atbm6bukwynhqlvps&st=3sdpmecg&raw=1' },
      { id: 'custom-3', name: 'Индивидуальный дизайн 3', note: 'Разработка дизайнером', price: 2900, previewImage: 'https://www.dropbox.com/scl/fo/32sdavmje7anx9fg8h13a/AKzgf8MyTITN8tOBkPRvLEk/003.png?rlkey=hko8iad8atbm6bukwynhqlvps&st=1qcfqkq1&raw=1' },
      { id: 'custom-4', name: 'Индивидуальный дизайн 4', note: 'Разработка дизайнером', price: 1900, previewImage: 'https://www.dropbox.com/scl/fo/32sdavmje7anx9fg8h13a/AH_cKJkhh_G52dcEwLxF2PA/004.png?rlkey=hko8iad8atbm6bukwynhqlvps&st=k7ryeajv&raw=1' },
      { id: 'custom-5', name: 'Индивидуальный дизайн 5', note: 'Разработка дизайнером', price: 2400, previewImage: 'https://www.dropbox.com/scl/fo/32sdavmje7anx9fg8h13a/AD61t47Vw12hFLRbKG0C1c8/005.png?rlkey=hko8iad8atbm6bukwynhqlvps&st=70qbzdo6&raw=1' },
      { id: 'custom-6', name: 'Индивидуальный дизайн 6', note: 'Разработка дизайнером', price: 2900, previewImage: 'https://www.dropbox.com/scl/fo/32sdavmje7anx9fg8h13a/ADU0wBCowM9BTqActIBrbzk/006.png?rlkey=hko8iad8atbm6bukwynhqlvps&st=fk9c1ez0&raw=1' },
    ],
...
// ===== constructor-checkout-mvp-tilda-js-1.html =====
    ...
    // =====================================================================
    const KONVA_DEV_MODE = true; // <<< set true for development
    ...
    const KONVA_TEMPLATE_CONFIGS = {
      ...
      'polaroid-photo': {
        ...
        photoPosition: 'center',
        photoDefaults: { exportX: 464.2, exportY: 485.1, scaleX: 0.659, scaleY: 0.692 },
        frameDefaults: { exportX: 456, exportY: 483, scale: 0.8 },
        printSizeOverrides: {
          l: { photoExportX: 449, photoExportY: 487, photoScaleX: 0.664, photoScaleY: 0.697, frameExportX: 436, frameExportY: 483, frameScale: 0.822 },
        },
      ...
      'polaroid-top-text': {
        ...
        photoDefaults: { exportX: 464, exportY: 487, scaleX: 0.659, scaleY: 0.692 },
        // Рамка: позиция как фото в photo-top-text
        frameDefaults: { exportX: 456, exportY: 503, scale: 0.8 },
        textDefaults: { exportX: 500, exportCenterY: 490, anchor: 'middle' },
        textScaleMultiplier: 1.381,
        printSizeOverrides: {
          l: { photoExportX: 449, photoExportY: 488, photoScaleX: 0.664, photoScaleY: 0.697, frameExportX: 436, frameExportY: 503, frameScale: 0.822 },
          m: { exportCenterY: 493, textScaleMultiplier: 1.503 },
          's:s': { photoExportY: 499, frameExportY: 496 },
          'm:s': { photoExportY: 506, frameExportY: 504 },
          's:l': { photoExportX: 449, photoExportY: 501, photoScaleX: 0.664, photoScaleY: 0.697, frameExportX: 436, frameExportY: 496, frameScale: 0.822 },
          'm:l': { photoExportX: 449, photoExportY: 509, photoScaleX: 0.664, photoScaleY: 0.697, frameExportX: 436, frameExportY: 503, frameScale: 0.822 },
        },
        textGap: { preview: 16, export: 20 }, textDescentRatio: 0.32,
      ...
      'polaroid-diagonal-text': {
        ...
        textScaleMultiplier: 1.381,
        printSizeOverrides: {
          l: { photoExportX: 449, photoExportY: 488, photoScaleX: 0.664, photoScaleY: 0.697, frameExportX: 436, frameExportY: 483, frameScale: 0.822 },
          m: { exportCenterY: 493, textScaleMultiplier: 1.503 },
        },
        diagonalText: { rotation: -24, xRatio: 0.87, previewTopRatio: 0.81, exportBaselineRatio: 0.9 },
      ...
      'polaroid-inside-text': {
        ...
        printSizeOverrides: {
          's:l': { photoExportX: 449, photoExportY: 488, photoScaleX: 0.664, photoScaleY: 0.697, frameExportX: 436, frameExportY: 483, frameScale: 0.822, exportX: 553.1, exportCenterY: 623.6, textScaleMultiplier: 0.45 },
        },
        layerOrder: ['photo', 'polaroidFrame', 'text'],
      },
    };
    ...
    function konvaResolveScene(params) {
      ...
      if (isCustom) {
        const customTpl = customTemplates.find((c) => c.id === params.customTemplateId);
        if (customTpl && customTpl.previewImage) {
          ...
          const imgW = photoExportWidth * spScale;
          const imgH = photoExportHeight * spScale;
          const imgX = spDefaults.exportX ?? (KONVA_EXPORT_W - imgW) / 2;
          const imgY = spDefaults.exportY ?? 483;
          scene.elements.push({ type: 'custom-preview', name: 'customPreview', x: imgX, y: imgY, width: imgW, height: imgH, src: customTpl.previewImage });
        }
        return scene;
      }
    ...
    function buildKonvaSceneParams() {
      ...
      return {
        ...
        customTemplateId: state.selectedCustom || null,
    ...
    function setupPreviewZoom() {
      ...
      const applyDesktopZoom = (e, animate) => {
        ...
        const tx = -fx * (DESKTOP_ZOOM - 1) * rect.width;
        const ty = -fy * (DESKTOP_ZOOM - 1) * rect.height;
        garmentWrap.style.transition = animate ? 'transform .2s ease' : 'none';
        garmentWrap.style.transform = `translate(${tx}px, ${ty}px) scale(${DESKTOP_ZOOM})`;
    ...
    const getProductionTotal = () => state.superFastProduction ? 800 : state.fastProduction ? 500 : 0;
    ...
    function getPersistenceStateSnapshot() {
      ...
      return {
        ...
        superFastProduction: state.superFastProduction,
    ...
    function buildTildaCartTitle(payload = getOrderPayload()) {
      ...
      const parts = [
        ...
        payload.superFastProduction ? 'Производство за 24 часа' : payload.fastProduction ? 'Ускоренное производство' : '',
    ...
    function updateOrderFormFields() {
      ...
      const summaryLines = [
        ...
        `Ускоренное производство: ${payload.superFastProduction ? 'За 24 часа' : payload.fastProduction ? 'Да' : 'Нет'}`,
    ...
    async function createCheckoutCompositePreviewUrl(options = {}) {
      ...
      if (state.selectedCustom) {
        ...
        if (customTpl && customTpl.previewImage) {
          ...
          const spDefaults = spConfig?.photoDefaults || {};
          const spScale = spDefaults.scale || 0.8;
          const cpW = 110 * spScale;
          const cpH = 138 * spScale;
          const cpX = spDefaults.exportX ?? (1000 - cpW) / 2;
          const cpY = spDefaults.exportY ?? 483;
    ...
    async function renderCheckoutCompositePreviewCanvas(canvas) {
      ...
      if (state.selectedCustom || !selectedTemplate) {
        if (state.selectedCustom) {
          ...
          if (customTpl && customTpl.previewImage) {
            try {
              const cpImg = await loadImageElement(customTpl.previewImage);
              const spConfig = KONVA_TEMPLATE_CONFIGS['simple-photo'];
              const spDefaults = spConfig?.photoDefaults || {};
              const spScale = spDefaults.scale || 0.8;
              const cpW = 110 * spScale;
          ...
          <div class="checkout-review-grid">
            ...
            <div class="info-card production-card">
              <div style="display:flex; align-items:center; justify-content:space-between; gap:12px; flex-wrap:wrap;">
                ...
                <div class="status-pill ${(state.fastProduction || state.superFastProduction) ? 'ok' : ''}" style="margin:0;">${state.superFastProduction ? '✓ За 24 часа' : state.fastProduction ? '✓ Ускорение включено' : 'Стандартное производство'}</div>
              </div>
              <div class="stack" style="margin-top:16px;">
                ...
                <button class="toggle-card ${state.superFastProduction ? 'active' : ''}" id="superFastProductionBtn" type="button">
                  <div style="text-align:left;">
                    <div style="font-weight:600;">Сделать за 24 часа</div>
                    <div class="subtext">Максимальный приоритет</div>
                  </div>
    ...
    function bindStepEvents() {
      ...
      if (state.step === 6) {
        ...
        document.getElementById('fastProductionBtn')?.addEventListener('click', () => {
          ...
          if (state.fastProduction) state.superFastProduction = false;
          render();
        });
        document.getElementById('superFastProductionBtn')?.addEventListener('click', () => {
          state.superFastProduction = !state.superFastProduction;
          if (state.superFastProduction) state.fastProduction = false;
          render();
        });
        const emailInput = document.getElementById('configuratorEmail');
        const nameInput = document.getElementById('configuratorName');
      ...
      if (!hideDesign && state.selectedCustom) {
        ...
        if (customTpl && customTpl.previewImage) {
          html = `
            <div
              class="image-box"
              style="left:50%; top:38.64%; width:8.8%; height:8.83%; border:none; border-radius:0; background:transparent;"
            >
