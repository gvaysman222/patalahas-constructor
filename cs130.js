...
// ===== constructor-checkout-mvp-tilda-js-1.html =====
    ...
    const KONVA_TEMPLATE_CONFIGS = {
      ...
      'photo-bottom-text': {
        ...
        printSizeOverrides: {
          l: { photoExportX: 436, photoExportY: 483, photoScale: 0.822 },
          m: { exportCenterY: 493, textScaleMultiplier: 1.503 },
          's:s': { photoExportY: 483, exportCenterY: 621.5 },
          'm:s': { photoExportY: 483, exportCenterY: 621.5 },
          's:l': { photoExportX: 436, photoExportY: 483, photoScale: 0.822, exportCenterY: 675 },
          'm:l': { photoExportX: 436, photoExportY: 483, photoScale: 0.822, exportCenterY: 675 },
        },
    ...
    function konvaResolveScene(params) {
      ...
      if (config.hasText && textLines.length > 0) {
        const comboTextOverride = (comboKey && config.printSizeOverrides && config.printSizeOverrides[comboKey]) || {};
        const td = { ...textExportOverrides, ...config.textDefaults, ...psOverride, ...comboTextOverride };
        if (config.textPosition === 'diagonal-photo' && config.diagonalText) {
          ...
          textLayout = { x: td.exportX || 500, y: belowY, fontSize, lineHeight, anchor: td.anchor || 'middle', rotation: 0, clipRect: null };
