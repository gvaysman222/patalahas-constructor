...
// ===== constructor-checkout-mvp-tilda-js-1.html =====
    ...
    const KONVA_TEMPLATE_CONFIGS = {
      'emb-center': {
        ...
        textPosition: 'center',
        textDefaults: { exportX: 500, exportCenterY: 465, exportCenterYWithUpload: 780, anchor: 'middle' },
        textScaleMultiplier: 1.969,
    ...
    function konvaResolveScene(params) {
      ...
      const textScaleMul = config.textScaleMultiplier || 1;
