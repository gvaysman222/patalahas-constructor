...
// ===== constructor-checkout-mvp-tilda-js-1.html =====
    ...
    const KONVA_TEMPLATE_CONFIGS = {
      ...
      'polaroid-diagonal-text': {
        ...
        diagonalFontOverrides: {
          'emb-center-print-font-3': {
            ...
            'm:l': { diagonalExportX: 566.1, diagonalExportY: 634.2 },
          },
        },
        layerOrder: ['photo', 'polaroidFrame', 'text'],
      },
      'polaroid-inside-text': {
        ...
        printSizeOverrides: {
          s: { photoExportX: 457.1, photoExportY: 486.9, photoScaleX: 0.782, photoScaleY: 0.802, frameExportX: 453, frameExportY: 483, frameScale: 0.947, exportX: 541.2, exportCenterY: 599.3 },
          's:l': { photoExportX: 448, photoExportY: 488, photoScaleX: 0.670, photoScaleY: 0.697, frameExportX: 443.6, frameExportY: 483, frameScale: 0.822, exportX: 553.1, exportCenterY: 626.6, textScaleMultiplier: 0.45 },
        },
        layerOrder: ['photo', 'polaroidFrame', 'text'],
      },
    };
    ...
    function getLineHeightScale(fontId = state.font, template = getSelectedTemplate()) {
      ...
      if (!opt) return 1;
      const hasLower = textHasLowercase();
      const result = (hasLower && opt.lowercaseLineHeightScale != null) ? opt.lowercaseLineHeightScale : (opt.lineHeightScale || 1);
      console.log('[DEBUG getLineHeightScale]', JSON.stringify({ fontId, lineHeightScale: opt.lineHeightScale, lowercaseLHS: opt.lowercaseLineHeightScale, hasLower, result }));
      return result;
    }
