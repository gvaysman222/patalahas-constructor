...
// ===== constructor-checkout-mvp-tilda-js-1.html =====
    ...
    const KONVA_TEMPLATE_CONFIGS = {
      'emb-center': {
        ...
        textPosition: 'center',
        textDefaults: { exportX: 500, exportCenterY: 507, exportCenterYWithUpload: 780, anchor: 'middle' },
    ...
    function konvaUpdateDebugPanel(node) {
      ...
      const configMul = KONVA_TEMPLATE_CONFIGS[selectedTemplate?.kind]?.textScaleMultiplier || 1;
