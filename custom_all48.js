    ...
    function getDesignLayerRenderState() {
      ...
      if (!hideDesign && state.selectedCustom) {
        ...
        const insideTextBlockHtml = polaroidInsideTextLayout ? `
          ...
          >
            <div style="width:100%; max-width:none; color:${state.textColor}; text-align:center; line-height:${previewTextStyle.lineHeight}; font-weight:${previewTextStyle.fontWeight}; letter-spacing:${previewTextStyle.letterSpacing}; text-transform:${previewTextStyle.textTransform}; font-size:${previewTextStyle.fontSize}; font-family:${previewFontFamily}; transform:scale(${currentScale}); transform-origin:center center; display:-webkit-box; -webkit-box-orient:vertical; -webkit-line-clamp:${previewTextRules.maxLines}; overflow:hidden;">
              ${previewTextHtml}
            </div>
          </div>
        ` : '';
