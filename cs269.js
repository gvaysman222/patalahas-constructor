...
// ===== constructor-checkout-mvp-tilda-js-1.html =====
    ...
    const extras = [
      { id: 'hand-drawn', name: 'Рисованные элементы на фотографии', description: 'К любому шаблону с фотографией вы можете добавить рисованные элементы поверх фото. Итоговый макет будет выслан после работы дизайнера.', price: 300 },
      { id: 'polaroid-photo', name: 'Полароид', description: 'Ваши фотографии будут напечатаны на оригинальных картриджах Fujifilm', price: 390 },
      { id: 'cassette', name: 'Аудио открытка «кассета»', description: 'На кассету можно записать своё 60-секундное послание, которое получатель сможет прослушать.', price: 590 },
    ];
    // количество допов
    const extrasCount = {};
