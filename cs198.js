        ...
        const reviewStage = `
          <div class="checkout-review-grid">
            ...
            <div class="info-card production-card">
              ...
              <div class="production-comment" style="margin-top:12px;">
                <div class="field-title" style="font-size:13px; margin-bottom:4px;">Комментарий</div>
                <textarea id="configuratorComment" class="text-input production-comment-input" rows="1" placeholder="Пожелания к заказу" style="height:44px; max-height:44px; resize:none; overflow-y:auto; line-height:1.4; padding:10px 12px; min-height:0;">${escapeHtml(state.comment || '')}</textarea>
              </div>
            </div>
          </div>
