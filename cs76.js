...
// ===== constructor-checkout-mvp-tilda-js-1.html =====
    ...
    function konvaEnsurePreviewStage() {
      ...
      // Find or create container div — direct child of garmentWrap
      ...
      // Absolute over the whole garmentWrap, above .garment (z-index 15), pointer-events on
      div.style.cssText = [
        'position:absolute', 'inset:0', 'width:100%', 'height:100%',
        'z-index:15', 'pointer-events:' + (KONVA_DEV_MODE ? 'auto' : 'none'),
        'overflow:hidden',
      ].join(';');
      ...
      if (!konvaPreviewStage) {
        ...
        // Re-attach container if stage lost it (e.g. garmentWrap was re-rendered)
      ...
      konvaPreviewLayer.listening(true);
      konvaPreviewStage.listening(true);
