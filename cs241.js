...
(function initConstructorCheckoutTemplateConfig(global) {
  ...
  const centerPrintFonts = [
    ...
    },
    {
      ...
      fontWeight: 400,
      lowercasePreviewScale: 1.15,
      lowercaseExportScale: 1.15,
...
// ===== constructor-checkout-mvp-tilda-js-1.html =====
    ...
    function getPreviewFontScale(fontId = state.font, template = getSelectedTemplate()) {
      ...
      if (!opt) return 1;
      if (textHasLowercase() && opt.lowercasePreviewScale != null) return opt.lowercasePreviewScale;
      return opt.previewScale || 1;
    }
    function getExportFontScale(fontId = state.font, template = getSelectedTemplate()) {
      const opt = getSelectedFontOption(fontId, template);
      if (!opt) return 1;
      if (textHasLowercase() && opt.lowercaseExportScale != null) return opt.lowercaseExportScale;
      return opt.exportScale || 1;
    }
    function getLineHeightScale(fontId = state.font, template = getSelectedTemplate()) {
      const opt = getSelectedFontOption(fontId, template);
      if (!opt) return 1;
      if (textHasLowercase() && opt.lowercaseLineHeightScale != null) return opt.lowercaseLineHeightScale;
      return opt.lineHeightScale || 1;
    }
