          ...
          <div class="step-1-meta-row">
            <div class="step-1-size-block">
              ...
              <div class="size-row" style="margin-top:12px;">
                ...
                ${sizeChartImages[state.product] ? `<span class="size-chart-hint" tabindex="0" aria-label="Размерная сетка"><span class="size-chart-hint-icon">?</span><span class="size-chart-hint-tip"><img src="${sizeChartImages[state.product]}" alt="Размерная сетка"></span></span>` : ''}
              </div>
            </div>
          </div>
        </div>
