...
// ===== constructor-checkout-mvp-tilda-js-1.html =====
          ...
          <div class="step-1-meta-row">
            <div class="step-1-size-block">
              ...
              <div class="size-row" style="margin-top:12px;">
                ...
                ${sizeChartImages[state.product] ? `<span class="size-chart-hint" tabindex="0" aria-label="Размерная сетка" data-size-chart="${escapeAttr(sizeChartImages[state.product])}"><span class="size-chart-hint-icon">?</span></span>` : ''}
              </div>
            </div>
          </div>
        </div>
    ...
    (function setupSizeChartOverlay() {
      ...
      function positionOverlay(hint) {
        ...
        let top = rect.top + rect.height / 2 - oh / 2;
