...
function renderLeftSummary() {
    ...
    function renderVisualizer() {
      ...
      console.log('[renderVisualizer]', 'template:', selectedTemplate?.kind, 'printScale:', currentScale, 'baseImageScale:', productBaseImageScale, 'printSize:', selectedPrintSize?.id, 'garment.offsetWidth:', garment.offsetWidth, 'garment.offsetHeight:', garment.offsetHeight, 'baseImage.offsetWidth:', baseImage?.offsetWidth, 'baseImage.offsetHeight:', baseImage?.offsetHeight);
