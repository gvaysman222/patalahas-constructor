...
// ===== constructor-checkout-mvp-tilda-js-1.html =====
    ...
    const extras = [
      { id: 'hand-drawn', name: 'Рисованные элементы на фотографии', description: 'К любому шаблону с фотографией вы можете добавить рисованные элементы. Макет будет выслан после работы дизайнера.', price: 300 },
