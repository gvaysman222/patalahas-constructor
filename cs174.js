...
// ===== constructor-checkout-mvp-tilda-js-1.html =====
    ...
    const KONVA_TEMPLATE_CONFIGS = {
      ...
      'polaroid-top-text': {
        ...
        photoDefaults: { exportX: 465, exportY: 489, scaleX: 0.659, scaleY: 0.692 },
        // Рамка: позиция как фото в photo-top-text
        frameDefaults: { exportX: 456, exportY: 503, scale: 0.8 },
        textDefaults: { exportX: 500, exportCenterY: 490, anchor: 'middle' },
        textScaleMultiplier: 1.381,
        printSizeOverrides: {
          l: { photoExportX: 450, photoExportY: 490, photoScaleX: 0.664, photoScaleY: 0.697, frameExportX: 436, frameExportY: 503, frameScale: 0.822 },
          m: { exportCenterY: 493, textScaleMultiplier: 1.503 },
          's:s': { photoExportY: 501, frameExportY: 496 },
          'm:s': { photoExportY: 508, frameExportY: 504 },
          's:l': { photoExportX: 450, photoExportY: 503, photoScaleX: 0.664, photoScaleY: 0.697, frameExportX: 436, frameExportY: 496, frameScale: 0.822 },
          'm:l': { photoExportX: 450, photoExportY: 511, photoScaleX: 0.664, photoScaleY: 0.697, frameExportX: 436, frameExportY: 503, frameScale: 0.822 },
        },
        textGap: { preview: 16, export: 20 }, textDescentRatio: 0.32,
      ...
      'polaroid-diagonal-text': {
        ...
        textScaleMultiplier: 1.381,
        printSizeOverrides: {
          l: { photoExportX: 450, photoExportY: 490, photoScaleX: 0.664, photoScaleY: 0.697, frameExportX: 436, frameExportY: 483, frameScale: 0.822 },
          m: { exportCenterY: 493, textScaleMultiplier: 1.503 },
        },
        diagonalText: { rotation: -24, xRatio: 0.87, previewTopRatio: 0.81, exportBaselineRatio: 0.9 },
      ...
      'polaroid-inside-text': {
        ...
        printSizeOverrides: {
          's:l': { photoExportX: 450, photoExportY: 490, photoScaleX: 0.664, photoScaleY: 0.697, frameExportX: 436, frameExportY: 483, frameScale: 0.822, exportX: 553.1, exportCenterY: 625.6, textScaleMultiplier: 0.45 },
        },
        layerOrder: ['photo', 'polaroidFrame', 'text'],
      },
    };
    ...
    function showCartUploadOverlay() {
      ...
      if (!overlay) {
        ...
        style.textContent = `
          #cartUploadOverlay { position: fixed; inset: 0; z-index: 99999; display: flex; align-items: center; justify-content: center; pointer-events: all; }
