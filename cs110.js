...
function renderLeftSummary() {
    ...
    function getDesignLayerRenderState() {
      ...
      if (!hideDesign && state.selectedCustom) {
        html = '';
      } else if (!hideDesign && (isPolaroid || isPhotoTextTemplate(selectedTemplate)) && templatePhotoLayout) {
        const textBlockHtml = `
        ...
        const isPhotoFirst = isPhotoBottomTextTemplate(selectedTemplate)
          ...
          || isPolaroidBottomTextTemplate(selectedTemplate)
          || isPolaroidDiagonalTextTemplate(selectedTemplate)
          || isPolaroidInsideTextTemplate(selectedTemplate);
        html = isPhotoFirst
