...
// ===== constructor-checkout-mvp-tilda-js-1.html =====
    ...
    const KONVA_TEMPLATE_CONFIGS = {
      ...
      'polaroid-photo': {
        ...
        photoPosition: 'center',
        photoDefaults: { exportX: 458.1, exportY: 486.9, scaleX: 0.773, scaleY: 0.802 },
        frameDefaults: { exportX: 453, exportY: 483, scale: 0.947 },
        printSizeOverrides: {
          s: { photoExportX: 458.1, photoExportY: 486.9, photoScaleX: 0.773, photoScaleY: 0.802, frameExportX: 453, frameExportY: 483, frameScale: 0.947 },
      ...
      'photo-diagonal-text': {
        ...
        textScaleMultiplier: 1.381,
        printSizeOverrides: {
          l: { photoExportX: 453, photoExportY: 483, photoScale: 0.853 },
          m: { exportCenterY: 493, textScaleMultiplier: 1.503 },
      ...
      'polaroid-diagonal-text': {
        ...
        textScaleMultiplier: 1.381,
        printSizeOverrides: {
          s: { photoExportX: 458.1, photoExportY: 486.9, photoScaleX: 0.773, photoScaleY: 0.802, frameExportX: 453, frameExportY: 483, frameScale: 0.947, diagonalExportX: 538.7, diagonalExportY: 605 },
          l: { photoExportX: 449, photoExportY: 488, photoScaleX: 0.664, photoScaleY: 0.697, frameExportX: 443.6, frameExportY: 483, frameScale: 0.822, diagonalExportX: 548.5, diagonalExportY: 635.6 },
          m: { exportCenterY: 493, textScaleMultiplier: 1.503 },
        },
        diagonalText: { rotation: -24, xRatio: 0.87, previewTopRatio: 0.81, exportBaselineRatio: 0.9, lineHeightScale: 0.85 },
    ...
    function konvaResolveScene(params) {
      ...
      if (config.hasText && textLines.length > 0) {
        ...
        if (config.textPosition === 'diagonal-photo' && config.diagonalText) {
          ...
          const overrideX = comboOverride.diagonalExportX ?? psOverride.diagonalExportX ?? dt.exportX ?? null;
          ...
          const diagLH = dt.lineHeightScale != null ? lineHeight * dt.lineHeightScale : lineHeight;
          textLayout = { x: textX, y: textY, fontSize, lineHeight: diagLH, anchor: 'middle', rotation: dt.rotation, clipRect: null };
    ...
    function getPhotoDiagonalTextLayout(
      ...
      const diagonalXOverride = psOverride.diagonalExportX ?? konvaConfig?.diagonalText?.exportX ?? null;
      ...
      if (config) {
        ...
        if (isPhotoDiagonalTextTemplate(template)) {
          ...
          if (diagonalLayout) {
            ...
            const diagLHScale = diagKonva?.diagonalText?.lineHeightScale;
            return {
