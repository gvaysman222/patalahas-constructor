...
// ===== constructor-checkout-mvp-tilda-js-1.html =====
    ...
    function setupPreviewZoom() {
      ...
      // --- Desktop: hover = zoom, mousemove = move origin (loupe effect) ---
      const isDesktop = !window.matchMedia('(max-width: 768px)').matches;
      if (isDesktop) {
        garmentWrap.addEventListener('mouseenter', () => {
          garmentWrap.style.transition = 'transform .2s ease';
          garmentWrap.style.transform = `scale(${DESKTOP_ZOOM})`;
        ...
        garmentWrap.addEventListener('mousemove', (e) => {
          ...
          garmentWrap.style.transition = 'transform-origin .05s linear';
