        ...
        const reviewStage = `
          <div class="checkout-review-grid">
            ...
            <div class="info-card production-card">
              ...
              <div class="production-comment" style="margin-top:16px;">
                <div class="field-title" style="font-size:14px; margin-bottom:6px;">Комментарий</div>
                <textarea id="configuratorComment" class="text-input text-input--multiline" rows="2" placeholder="Пожелания к заказу">${escapeHtml(state.comment || '')}</textarea>
              </div>
            </div>
          </div>
