...
// ===== constructor-checkout-mvp-tilda-js-1.html =====
    ...
    function setupPreviewZoom() {
      ...
      const setZoom = (zoom, animate) => {
        garmentWrap.style.transition = animate ? 'transform .25s ease' : 'none';
        garmentWrap.style.transform = zoom > 1 ? `scale(${zoom})` : '';
        currentZoom = zoom;
      };
      ...
      // --- Desktop: click to zoom in at cursor, click again to zoom out ---
