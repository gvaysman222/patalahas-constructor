...
// ===== constructor-checkout-mvp-tilda-js-1.html =====
    ...
    const POLAROID_FRAME_EXPORT_WIDTH = 126;
    const POLAROID_FRAME_EXPORT_HEIGHT = 176;
    const POLAROID_FRAME_EXPORT_TOP = 430;
    const POLAROID_FRAME_EXPORT_X_OFFSET = 10;
    ...
    function getPolaroidFrameLayout() {
      const exportX = ((CHECKOUT_EXPORT_ARTBOARD_WIDTH - POLAROID_FRAME_EXPORT_WIDTH) / 2) + POLAROID_FRAME_EXPORT_X_OFFSET;
      const exportY = POLAROID_FRAME_EXPORT_TOP;
      const photoExportX = exportX + (POLAROID_FRAME_EXPORT_WIDTH * POLAROID_FRAME_INNER_X_RATIO);
      const photoExportY = exportY + (POLAROID_FRAME_EXPORT_HEIGHT * POLAROID_FRAME_INNER_Y_RATIO);
      const photoExportWidth = POLAROID_FRAME_EXPORT_WIDTH * POLAROID_FRAME_INNER_WIDTH_RATIO;
      const photoExportHeight = POLAROID_FRAME_EXPORT_HEIGHT * POLAROID_FRAME_INNER_HEIGHT_RATIO;
      return {
        exportX,
        exportY,
        exportWidth: POLAROID_FRAME_EXPORT_WIDTH,
        exportHeight: POLAROID_FRAME_EXPORT_HEIGHT,
        photoExportX,
        photoExportY,
        photoExportWidth,
        photoExportHeight,
        ...
        previewWidth: `${(POLAROID_FRAME_EXPORT_WIDTH / CHECKOUT_EXPORT_ARTBOARD_WIDTH) * 100}%`,
        previewHeight: `${(POLAROID_FRAME_EXPORT_HEIGHT / CHECKOUT_EXPORT_ARTBOARD_HEIGHT) * 100}%`,
    ...
    function getPolaroidDiagonalTextLayout(
      ...
      const frameLayout = getPolaroidFrameLayout();
...
// ===== constructor-checkout-mvp-tilda-js-1-preview.html =====
    ...
    async function createCheckoutCompositePreviewUrl(options = {}) {
      ...
      const polaroidFrameLayout = isPolaroidTemplate ? getPolaroidFrameLayout() : null;
    ...
    async function renderCheckoutCompositePreviewCanvas(canvas) {
      ...
      if (isPolaroidTemplate) {
        const polaroidFrameLayout = getPolaroidFrameLayout();
