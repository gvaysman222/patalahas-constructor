    ...
    function getDesignLayerRenderState() {
      ...
      if (!hideDesign && state.selectedCustom) {
        ...
        html = activeUpload ? `
          <div
            class="image-box"
            style="left:${simplePhotoLayout.previewLeft}; top:${simplePhotoLayout.previewTop}; width:${simplePhotoLayout.previewWidth}; height:${simplePhotoLayout.previewHeight}; border:none; border-radius:0; background:transparent;"
          >
            ${uploadsHtml}
          </div>
        ` : '';
