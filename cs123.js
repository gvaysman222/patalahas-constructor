...
// ===== constructor-checkout-mvp-tilda-js-1.html =====
    ...
    const KONVA_TEMPLATE_CONFIGS = {
      ...
      'simple-photo': {
        ...
        printSizeOverrides: {
          l: { photoExportX: 435, photoExportY: 483, photoScale: 0.822 },
        },
        layerOrder: ['photo'],
      },
      'photo-top-text': {
        ...
        photoDefaults: { exportX: 455, exportY: 503, scale: 0.8 },
        textDefaults: { exportX: 500, exportCenterY: 490, anchor: 'middle' },
        textScaleMultiplier: 1.381,
        printSizeOverrides: {
          l: { photoExportX: 435, photoExportY: 503, photoScale: 0.822 },
          m: { exportCenterY: 493, textScaleMultiplier: 1.503 },
        },
      ...
      'photo-bottom-text': {
        ...
        textScaleMultiplier: 1.381,
        printSizeOverrides: {
          l: { photoExportX: 440, photoExportY: 483, photoScale: 0.822 },
          m: { exportCenterY: 493, textScaleMultiplier: 1.503 },
        },
    ...
    function konvaResolveScene(params) {
      ...
      if (config.hasPhoto) {
        ...
        const photoOverride = (config.printSizeOverrides && config.printSizeOverrides[photoPrintSizeId]) || psOverride;
